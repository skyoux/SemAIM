...
def main(args):
    ...
    optimizer = torch.optim.SGD(model_without_ddp.head.parameters(), lr=args.lr, weight_decay=args.weight_decay,
                                momentum=0.9)
    print(optimizer)
    ...
    # resume model
    ckpt_path = os.path.join(args.output_dir, f"{args.model}.{args.experiment}.linear.pth")
